            ...
            if (storeProcFile.isDirectory()) {
                ...
                for (File listofstoreprocFile : listofstoreprocFiles) {
                    ...
                    for (String storeproc : storeproclist) {
                        ...
                        String aliasstar = QueryParserForStar.getChangedForAliasQuery(updatedSQL);
                        String updatedqueryForStar = QueryParserForStar.getChangedQuery(aliasstar);
