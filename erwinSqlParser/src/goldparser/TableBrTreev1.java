 ...
 * @author sashikant D
 */
public class TableBrTreev1 {

    public static List<Map<String, List<String>>> sourceTableMap(String BusinessRule, String columnName, String egtfilepath,String orphanTableName) {
        ...
        try {
            ...
            //get Map from tree
            maplist = tablecolumnMap(valuestring.toUpperCase(),orphanTableName);
        long endtime = System.currentTimeMillis();
        long stat = endtime-starttime;
        long statsecond = TimeUnit.MILLISECONDS.toSeconds(stat);
            System.out.println("--goldparser---"+statsecond);
        } catch (Exception e) {
            e.printStackTrace();
...
//                    }
    ...
    public static List<Map<String, List<String>>> tablecolumnMap(String tree,String orphanTableName) {
        ...
        try {
            ...
            for (String tabcol : tablecolumndata) {
                if (!tabcol.contains(".")) {
                    String orphantableName = orphanTableName;
                    if (tabcol.contains(",")) {
